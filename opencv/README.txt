...
python save_snapshots.py --dwidth --dheight <camera output pix> --folder <folder to save images>

5) put all the images in a folder (if folder arg was given, don't need to)

6) Open a terminal
execute the cameracalib.py by calling: 
...
7) Use the output files (calibration matrix)
